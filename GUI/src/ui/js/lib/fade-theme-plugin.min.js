...
!(function (e, t) {
    ...
    class n {
        ...
        on(e, t, n = {}) {
            var s;
            t =
                !(s = t).name.startsWith("bound ") ||
                s.hasOwnProperty("prototype")
                    ? t.bind(this)
                    : t;
            const o = this.swup.hooks.on(e, t, n);
            return this.handlersToUnregister.push(o), o;
        }
        once(t, n, s = {}) {
            return this.on(t, n, e({}, s, { once: !0 }));
        }
        before(t, n, s = {}) {
            return this.on(t, n, e({}, s, { before: !0 }));
        }
        replace(t, n, s = {}) {
            return this.on(t, n, e({}, s, { replace: !0 }));
        }
        off(e, t) {
    ...
    class s extends n {
        ...
        _afterUnmount() {
            (this.swup.options.animationSelector =
                this._originalAnimationSelectorOption),
                this._addedStyleElements.forEach((e) => {
                    e.outerHTML = "";
                }),
                (this._addedStyleElements = []),
                this._addedHTMLContent.forEach((e) => {
                    e.outerHTML = "";
                }),
                (this._addedHTMLContent = []),
                this._classNameAddedToElements.forEach((e) => {
                    Array.from(document.querySelectorAll(e.selector)).forEach(
                        (e) => {
                            e.className.split(" ").forEach((t) => {
                                new RegExp("^swup-transition-").test(t) &&
        ...
        applyStyles(e) {
            ...
            t.setAttribute("data-swup-theme", ""),
                t.appendChild(document.createTextNode(e)),
                document.head.prepend(t),
                this._addedStyleElements.push(t);
        }
        applyHTML(e) {
        ...
        addClassName(e, t) {
            this._classNameAddedToElements.push({ selector: e, name: t }),
                this._addClassNameToElement();
        }
    }
